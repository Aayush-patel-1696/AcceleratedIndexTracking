...
with open(r'C:\Users\aayus\Documents\GitHub\AcceleratedIndexTracking\returns_500.dat','r') as f:
...
for k in range(test_scenarios):
    PortfolioTestReturn[k] = sum(Portfolio[i].x * Testreturn[i+1,k] for i in range(Assets-1))       
